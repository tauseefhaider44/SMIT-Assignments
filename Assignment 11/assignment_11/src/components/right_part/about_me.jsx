    ...
    return (
        <>
            <div className="about_Container">
                <h1>About Me</h1>
                <hr className="my_Hr" />
                <p>I'm Creative Director and Designer from Sydney, Australia, working in web development and print media. I enjoy turning complex problems into simple, beautiful and intuitive designs.</p>
